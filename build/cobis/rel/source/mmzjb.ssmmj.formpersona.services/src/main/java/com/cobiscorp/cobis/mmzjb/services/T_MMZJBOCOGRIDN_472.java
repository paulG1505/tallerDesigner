 ...
 * T_MMZJBOCOGRIDN_472 - FormPersona 
 *
 */
@Path("/MMZJB/SSMMJ/T_MMZJBOCOGRIDN_472")
@Component
@Service({T_MMZJBOCOGRIDN_472.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MMZJB)(task.submodule=SSMMJ)(task.id=T_MMZJBOCOGRIDN_472)(task.version=1.0.0))")
,@Reference(name="VW_PERSONAFCZ_284", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PERSONAFCZ_284)(view.version=1.0.0))")
...
public class T_MMZJBOCOGRIDN_472 {
