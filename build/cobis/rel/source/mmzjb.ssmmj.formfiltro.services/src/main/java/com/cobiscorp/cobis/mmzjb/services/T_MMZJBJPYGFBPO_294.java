 ...
 * T_MMZJBJPYGFBPO_294 - FormFiltro 
 *
 */
@Path("/MMZJB/SSMMJ/T_MMZJBJPYGFBPO_294")
@Component
@Service({T_MMZJBJPYGFBPO_294.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MMZJB)(task.submodule=SSMMJ)(task.id=T_MMZJBJPYGFBPO_294)(task.version=1.0.0))")
,@Reference(name="VW_FILTROSPBD_328", 
...
public class T_MMZJBJPYGFBPO_294 {
