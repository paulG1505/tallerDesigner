/*
 * Archivo: T_MMZJBLUNRNLXJ_384.java
 * Fecha: 2020-12-22T22:50:18Z
 *
 ...
 */
package com.cobiscorp.cobis.mmzjb.services;
 ...
 * T_MMZJBLUNRNLXJ_384 - FormProspecto 
 *
 */
@Path("/MMZJB/SSMMJ/T_MMZJBLUNRNLXJ_384")
@Component
@Service({T_MMZJBLUNRNLXJ_384.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MMZJB)(task.submodule=SSMMJ)(task.id=T_MMZJBLUNRNLXJ_384)(task.version=1.0.0))")
,@Reference(name="VW_PROSPECTOO_970", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PROSPECTOO_970)(view.version=1.0.0))")
,@Reference (name="QV_BY39_XAS13",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_BY39_XAS13)")
,@Reference(name="Q_PROSPCCT_UB39",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PROSPCCT_UB39)(query.version=1.0.0))")
...
public class T_MMZJBLUNRNLXJ_384 {
