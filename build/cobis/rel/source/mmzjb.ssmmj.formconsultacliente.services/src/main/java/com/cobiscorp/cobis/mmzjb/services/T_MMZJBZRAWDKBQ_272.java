 ...
 * T_MMZJBZRAWDKBQ_272 - FormConsultaCliente 
 *
 */
@Path("/MMZJB/SSMMJ/T_MMZJBZRAWDKBQ_272")
@Component
@Service({T_MMZJBZRAWDKBQ_272.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MMZJB)(task.submodule=SSMMJ)(task.id=T_MMZJBZRAWDKBQ_272)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTETWV_623", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTETWV_623)(view.version=1.0.0))")
,@Reference (name="QV_RL23_CYN42",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_RL23_CYN42)")
...
public class T_MMZJBZRAWDKBQ_272 {
