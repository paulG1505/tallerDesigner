...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI7158_bli_tipoa")
})
public class BLI7158_bli_tipoa implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI7158_bli_tipoa.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      mapper.addInputParameter("@i_operacion", SqlType.CHAR, "A");
      ...
      mapperSp1.addMapper(Prospecto.TELEFONO, 7);
