...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI5776_cli_consulta_cliente")
})
public class BLI5776_cli_consulta_cliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI5776_cli_consulta_cliente.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      mapperSp1.addMapper(Cliente.IDCLIENTE, 1);
