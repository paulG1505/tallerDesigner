...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI6154_bli_cliente")
})
public class BLI6154_bli_cliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI6154_bli_cliente.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      if (logger.isDebugEnabled()) {
        logger.logDebug("inputParameters: " + " NOMBRE: " + wnombre + " APELLIDO: " + wapellido + " TELEFONO: " + wtelefono + " CEDULA: " + wcedula + " NACIONALIDAD: " + wnacionalidad);
      }
