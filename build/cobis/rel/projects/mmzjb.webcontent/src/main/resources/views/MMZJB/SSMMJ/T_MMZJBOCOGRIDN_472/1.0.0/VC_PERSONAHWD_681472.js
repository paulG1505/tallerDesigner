...
designerEvents.api.formpersona = designerEvents.api.formpersona || designer.dsgEvents();

function VC_PERSONAHWD_681472(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_PERSONAHWD_681472_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_PERSONAHWD_681472_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout, $translate) {
        ...
        $scope.vc = designer.initViewContainer({
            ...
            "${contextPath}/resources/MMZJB/SSMMJ/T_MMZJBOCOGRIDN_472",
        designerEvents.api.formpersona,
        $scope.rowData);
        $scope.kendo = kendo;
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.temporarySave = function() {
                ...
                $scope.vc.execute("temporarySave", VC_PERSONAHWD_681472, data, function() {});
            };
            $scope.vc.temporaryRead = function() {
                if (page.hasTemporaryDataSupport) {
                    ...
                    return $scope.vc.executeService("readTemporaryData", VC_PERSONAHWD_681472, data).then(

                    function(response) {
                        var result = $scope.vc.processTemporaryResponse(response);
                        if (result) {
                            $scope.vc.execute("deleteTemporaryData", VC_PERSONAHWD_681472, data, function() {});
            ...
            $scope.vc.viewState.VC_PERSONAHWD_681472 = {
                style: []
            };
            ...
            //ViewState - Entity: Persona, Attribute: telefono
            $scope.vc.createViewState({
            ...
            $scope.vc.createViewState({
                id: "VA_SEXORFDIPCOVPDK_931284",
                componentStyle: [],
                label: "MMZJB.LBL_MMZJB_GENEROVWQ_11955",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All,
            ...
            $scope.vc.catalogs.VA_SEXORFDIPCOVPDK_931284 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_SEXORFDIPCOVPDK_931284', 'cl_sexo', function(response) {
                            var data = [];
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_SEXORFDIPCOVPDK_931284'];
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_SEXORFDIPCOVPDK_931284", true, data[0], 'code', data);
                            $scope.vc.setEnableAndReadonlyStatus("VA_SEXORFDIPCOVPDK_931284");
                        }, null, options.data.filter, 0);
                    }
                },
                requestStart: function(e) {
                    $scope.vc.requestStartRead(e, "VA_SEXORFDIPCOVPDK_931284", null);
                },
            ...
            $scope.vc.createViewState({
                id: "T_MMZJBOCOGRIDN_472_CANCEL",
                componentStyle: [],
                label: 'Cancel',
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Command: insertar
            $scope.vc.createViewState({
                id: "CM_TMMZJBOC_SC6",
                componentStyle: [],
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_PERSONAHWD_681472');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_PERSONAHWD_681472", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "MMZJB"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_PERSONAHWD_681472", {
            templateUrl: "VC_PERSONAHWD_681472_FORM.html",
            controller: "VC_PERSONAHWD_681472_CTRL",
            label: "FormPersona",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_PERSONAHWD_681472?" + $.param(search);
            }
        });
        VC_PERSONAHWD_681472(cobisMainModule);
    }]);
} else {
    VC_PERSONAHWD_681472(cobisMainModule);
}