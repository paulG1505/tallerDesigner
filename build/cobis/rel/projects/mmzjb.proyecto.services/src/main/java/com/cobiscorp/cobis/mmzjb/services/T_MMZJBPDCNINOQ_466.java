 ...
 * T_MMZJBPDCNINOQ_466 - FormConsulta 
 *
 */
@Path("/MMZJB/SSMMJ/T_MMZJBPDCNINOQ_466")
@Component
@Service({T_MMZJBPDCNINOQ_466.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MMZJB)(task.submodule=SSMMJ)(task.id=T_MMZJBPDCNINOQ_466)(task.version=1.0.0))")
,@Reference(name="VW_EMLZNEADPO_478", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EMLZNEADPO_478)(view.version=1.0.0))")
,@Reference (name="QV_RD85_WCU72",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_RD85_WCU72)")
...
public class T_MMZJBPDCNINOQ_466 {
