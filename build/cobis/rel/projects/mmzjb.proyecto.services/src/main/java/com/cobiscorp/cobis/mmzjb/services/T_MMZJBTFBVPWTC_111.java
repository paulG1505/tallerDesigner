 ...
 * T_MMZJBTFBVPWTC_111 - FormCliente 
 *
 */
@Path("/MMZJB/SSMMJ/T_MMZJBTFBVPWTC_111")
@Component
@Service({T_MMZJBTFBVPWTC_111.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MMZJB)(task.submodule=SSMMJ)(task.id=T_MMZJBTFBVPWTC_111)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTEACL_646", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTEACL_646)(view.version=1.0.0))")
...
public class T_MMZJBTFBVPWTC_111 {
